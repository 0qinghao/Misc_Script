...
function replace_1st_f(yuv1, yuv2)
    ...
    [x265_1st_YUV] = yuvRead_3ch(yuv1,w,h,1);
    [src_1_50_YUV] = yuvRead_3ch(yuv2,w,h,50);
    yuv_x265dec1_src49 = [x265_1st_YUV;src_1_50_YUV(w*h*1.5+1:end)];
    fid = fopen(strcat(file_name,"_x265dec1src2toend.yuv"),'w');
    fwrite(fid,yuv_x265dec1_src49);
    fclose(fid);
end