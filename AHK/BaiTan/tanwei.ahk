...
^r::
    Loop
    {
        ...
        ImageSearch, Px, Py, sr_tanwei.x0, sr_tanwei.y0, sr_tanwei.x1, sr_tanwei.y1, *50 hpmp.png
        if (ErrorLevel=0 and flg=0)
        {
            ...
            ImageSearch, Px, Py, sr_tanwei.x0, sr_tanwei.y0, sr_tanwei.x1, sr_tanwei.y1, *50 gmtw.png
            if (ErrorLevel=0 and flg=0)
            {
                Click, %Px%, %Py%
        ...
        else
        {
            ...
            ImageSearch, Px, Py, sr_tanwei.x0, sr_tanwei.y0, sr_tanwei.x1, sr_tanwei.y1, *80 aoi.png
            if (ErrorLevel=0 and flg=0)
            {
                ; for i,v in ok
                ; {
            ...
            {
                ImageSearch, Px, Py, sr_tanwei.x0, sr_tanwei.y0, sr_tanwei.x1, sr_tanwei.y1, *50 close.png
                if (ErrorLevel=0 and flg=0)
                {
                    Click, %Px%, %Py%
            ...
            ImageSearch, Px, Py, sr_tanwei.x0, sr_tanwei.y0, sr_tanwei.x1, sr_tanwei.y1, *50 cz.png
            if (ErrorLevel=0 and flg=0)
            {
                Click, %Px%, %Py%, Left
            ...
            ImageSearch, Px, Py, sr_tanwei.x0, sr_tanwei.y0, sr_tanwei.x1, sr_tanwei.y1, *50 sure.png
