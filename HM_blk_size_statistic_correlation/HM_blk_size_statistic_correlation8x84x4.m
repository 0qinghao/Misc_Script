...
stat_str = "DC Ratio 4 8 layer";
stat_log_4 = [0]; stat_log_8 = [0];
for i = 1:file_cnt
    % for i = 1:4:file_cnt
    ...
    for y = 1:8:1088
        for x = 1:8:1920
            if ((t_HM_blk_size_mat(y, x) == 4) && (t_HM_blk_size_mat(y, x + 4) == 4) && (t_HM_blk_size_mat(y + 4, x) == 4) && (t_HM_blk_size_mat(y + 4, x + 4) == 4))
                satd_4_blk = [satd44(y_res(y:y + 3, x:x + 3, i)), satd44(y_res(y:y + 3, x + 4:x + 7, i)), satd44(y_res(y + 4:y + 7, x:x + 3, i)), satd44(y_res(y + 4:y + 7, x + 4:x + 7, i))];
                stat_log_4(end + 1) = dcr_simple(satd_4_blk);
                t_HM_blk_size_mat(y:y + 7, x:x + 7) = 0;
...
%             if ((t_HM_blk_size_mat(y, x) == 4) && (t_HM_blk_size_mat(y, x + 4) == 4) && (t_HM_blk_size_mat(y + 4, x) == 4) && (t_HM_blk_size_mat(y + 4, x + 4) == 4))
%                 satd_4_blk = [satd44(y_res(y:y + 3, x:x + 3, i)), satd44(y_res(y:y + 3, x + 4:x + 7, i)), satd44(y_res(y + 4:y + 7, x:x + 3, i)), satd44(y_res(y + 4:y + 7, x + 4:x + 7, i))];
%                 stat_log_4(end + 1) = sum(satd_4_blk);
%                 t_HM_blk_size_mat(y:y + 7, x:x + 7) = 0;
%             elseif (t_HM_blk_size_mat(y, x) == 8)
%                 satd_4_blk = [satd44(y_res(y:y + 3, x:x + 3, i)), satd44(y_res(y:y + 3, x + 4:x + 7, i)), satd44(y_res(y + 4:y + 7, x:x + 3, i)), satd44(y_res(y + 4:y + 7, x + 4:x + 7, i))];
%                 stat_log_8(end + 1) = sum(satd_4_blk);
%                 t_HM_blk_size_mat(y:y + 7, x:x + 7) = 0;
%             end
%         end
%     end
...
%                 stat_log_4(end + 1) = max([satd(y_res(y:y + 7, x:x + 7, i)), satd(y_res(y:y + 7, x + 8:x + 15, i)), satd(y_res(y + 8:y + 15, x:x + 7, i)), satd(y_res(y + 8:y + 15, x + 8:x + 15, i))]);
...
%             if ((t_HM_blk_size_mat(y, x) == 8) && (t_HM_blk_size_mat(y, x + 8) == 8) && (t_HM_blk_size_mat(y + 8, x) == 8) && (t_HM_blk_size_mat(y + 8, x + 8) == 8))
%                 satd_4_blk = [satd(y_res(y:y + 7, x:x + 7, i)), satd(y_res(y:y + 7, x + 8:x + 15, i)), satd(y_res(y + 8:y + 15, x:x + 7, i)), satd(y_res(y + 8:y + 15, x + 8:x + 15, i))];
%                 stat_log_4(end + 1) = vsatd(satd_4_blk);
%                 t_HM_blk_size_mat(y:y + 15, x:x + 15) = 0;
%             elseif (t_HM_blk_size_mat(y, x) == 16)
%                 satd_4_blk = [satd(y_res(y:y + 7, x:x + 7, i)), satd(y_res(y:y + 7, x + 8:x + 15, i)), satd(y_res(y + 8:y + 15, x:x + 7, i)), satd(y_res(y + 8:y + 15, x + 8:x + 15, i))];
...
%                 stat_log_4(end + 1) = dcr_simple(res_4_blk);
%                 t_HM_blk_size_mat(y:y + 15, x:x + 15) = 0;
%             elseif (t_HM_blk_size_mat(y, x) == 16)
%                 res_4_blk = [res_energy(y_res(y:y + 7, x:x + 7, i)), res_energy(y_res(y:y + 7, x + 8:x + 15, i)), res_energy(y_res(y + 8:y + 15, x:x + 7, i)), res_energy(y_res(y + 8:y + 15, x + 8:x + 15, i))];
...
%             if ((t_HM_blk_size_mat(y, x) == 8) && (t_HM_blk_size_mat(y, x + 8) == 8) && (t_HM_blk_size_mat(y + 8, x) == 8) && (t_HM_blk_size_mat(y + 8, x + 8) == 8))
%                 satd_4_blk = [satd(y_res(y:y + 7, x:x + 7, i)), satd(y_res(y:y + 7, x + 8:x + 15, i)), satd(y_res(y + 8:y + 15, x:x + 7, i)), satd(y_res(y + 8:y + 15, x + 8:x + 15, i))];
%                 stat_log_4(end + 1) = dcr_simple_DouCheck(satd_4_blk);
%                 t_HM_blk_size_mat(y:y + 15, x:x + 15) = 0;
%             elseif (t_HM_blk_size_mat(y, x) == 16)
%                 satd_4_blk = [satd(y_res(y:y + 7, x:x + 7, i)), satd(y_res(y:y + 7, x + 8:x + 15, i)), satd(y_res(y + 8:y + 15, x:x + 7, i)), satd(y_res(y + 8:y + 15, x + 8:x + 15, i))];
...
%         for x = 1:16:1920
%             if ((t_HM_blk_size_mat(y, x) == 8) && (t_HM_blk_size_mat(y, x + 8) == 8) && (t_HM_blk_size_mat(y + 8, x) == 8) && (t_HM_blk_size_mat(y + 8, x + 8) == 8))
%                 stat_log_4(end + 1) = blk_sobel_ana(sobel_res(y:y + 15, x:x + 15));
%                 t_HM_blk_size_mat(y:y + 15, x:x + 15) = 0;
%             elseif (t_HM_blk_size_mat(y, x) == 16)
...
%         for x = 1:16:1920
%             if ((t_HM_blk_size_mat(y, x) == 8) && (t_HM_blk_size_mat(y, x + 8) == 8) && (t_HM_blk_size_mat(y + 8, x) == 8) && (t_HM_blk_size_mat(y + 8, x + 8) == 8))
%                 stat_log_4(end + 1) = blk_var(y_src(y:y + 15, x:x + 15, i));
%                 t_HM_blk_size_mat(y:y + 15, x:x + 15) = 0;
%             elseif (t_HM_blk_size_mat(y, x) == 16)
...
%         for x = 1:16:1920
%             if ((t_HM_blk_size_mat(y, x) == 8) && (t_HM_blk_size_mat(y, x + 8) == 8) && (t_HM_blk_size_mat(y + 8, x) == 8) && (t_HM_blk_size_mat(y + 8, x + 8) == 8))
%                 stat_log_4(end + 1) = blk_sobel_ana(sobel_src(y:y + 15, x:x + 15));
%                 t_HM_blk_size_mat(y:y + 15, x:x + 15) = 0;
%             elseif (t_HM_blk_size_mat(y, x) == 16)
...
% Test TH
stat_log_4 = stat_log_4(2:end);
stat_log_8 = stat_log_8(2:end);
right_p_4 = [0]; right_p_8 = [0]; right_p = [0];
right_TH = min([stat_log_4, stat_log_8]):max([stat_log_4, stat_log_8]);
for i = right_TH
    right_4_cnt = sum(stat_log_4 < i); right_8_cnt = sum(stat_log_8 >= i);
    % right_4_cnt = sum(stat_log_4 > i); right_8_cnt = sum(stat_log_8 <= i);
    right_p_4(end + 1) = right_4_cnt / length(stat_log_4); right_p_8(end + 1) = right_8_cnt / length(stat_log_8);
    right_p(end + 1) = right_p_4(end) + right_p_8(end);
end
right_p = right_p(2:end); right_p_4 = right_p_4(2:end); right_p_8 = right_p_8(2:end);
[p_max, p_max_index] = max(right_p);
p_max_TH = right_TH(p_max_index)
right_p_4(p_max_index)
...
% for i = right_TH
%     right_4_cnt = sum(stat_log_4 < i); right_8_cnt = sum(stat_log_8 >= i);
%     right_p(end + 1) = (right_4_cnt + right_8_cnt) / (length(stat_log_4) + length(stat_log_8));
% end
...
% scatter
subplot(1, 3, 1)
x_4 = linspace(0, 100, length(stat_log_4)); x_8 = linspace(0, 100, length(stat_log_8));
plot(x_4, stat_log_4, '.', x_8, stat_log_8, '.')
set(gca, 'xtick', [], 'xticklabel', [], 'fontsize', 15);
ylabel(stat_str, 'fontsize', 15)
title(strcat(stat_str, " scatter"), 'fontsize', 15)
legend("4x4", "8x8", 'fontsize', 11)
% histogram
subplot(1, 3, 2:3)
h8 = histogram(stat_log_4, 'numbins', 100, 'normalization', 'probability', 'BinWidth', max([stat_log_4, stat_log_8]) / 100); hold; h16 = histogram(stat_log_8, 'numbins', 100, 'normalization', 'probability', 'BinWidth', max([stat_log_4, stat_log_8]) / 100);
